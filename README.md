...
Standalone desktop application for LTX-2.3 22B video generation, running on a single 24GB GPU via [StageHand](https://github.com/CodeAlexx/StageHand) block-swapping.
...
- **StageHand block-swap** — Streams 22B transformer (48 blocks, ~800MB each) through VRAM one at a time via pinned memory pool
...
### Performance (RTX 3090 Ti, 768x512)
